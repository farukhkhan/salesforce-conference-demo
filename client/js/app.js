    ...
    getSessionList(
        function (data) {
            ...
            for (var i=0; i<sessions.length; i++) {
                html += '<li class="table-view-cell"><a href="#sessions/'+ sessions[i].KHAN_771__Session__r.Id +'">' + sessions[i].KHAN_771__Session__r.Name + '</a></li>';
            }
            html =
                '<div class="page">' +
                    ...
                    '<div class="card">' +
                        '<ul class="table-view">' +
                            '<li class="table-view-cell">' +
                                ...
                                '<p>' + (session.KHAN_771__Session__r.KHAN_771__Session_Date__c || 'No time yet')+ '</p>' +
                            '</li>' +
